        ...
        <div class=" m-5 rounded">
            ...
            <div class="mb-3">
                ...
                <select class="form-select" aria-label="Default select example" id="categoria" name="categoria">
                    ...
                    <option value="Medias"@if ($producto['categoria'] == 'Medias') selected @endif>Medias</option>
                </select>
            </div>
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <textarea class="form-control" id="caracteristicas" name="caracteristicas"rows="5">@foreach($producto["caracteristicas"] as $item){{ $item->descripcion."\n" }}@endforeach</textarea>
